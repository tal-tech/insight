...
const tagsViewSlice = createSlice({
  ...
  initialState,
  reducers: {
    initBuryTag(state, action: PayloadAction<any>){
      state.initBury = action.payload.initPage
    },
...
export const { setActiveTag, addTag, removeTag, removeAllTag, removeOtherTag, initBuryTag } = tagsViewSlice.actions;
